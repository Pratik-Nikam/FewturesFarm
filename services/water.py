...
def crop_groundwater_irrigation():
    ...
    file_path = os.path.join(ROOT_DIR, "data/tests/crop-groundwater-irrigation.csv")

    crop_groundwater_irrigation_data = pd.read_csv(file_path, delimiter="\t", header=None)
...
def groundwater_level():
    file_path = os.path.join(ROOT_DIR, "data/tests/groundwater-level.csv")
